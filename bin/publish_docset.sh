...
# Name of the project
PROJECT_NAME="plinstrument"

PUBLIC_SVN_URL="http://plinstrument.googlecode.com/svn/"

DOCSET_ID="com.plausiblelabs.PLInstrument"
DOCSET_BUNDLE_NAME="Plausible Instrument"
